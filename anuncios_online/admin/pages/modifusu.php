...
header("Location: ../index.php");
 ...
 $cn = conexion();
	...
	$consulta = mysqli_query($cn,"SELECT * FROM usuario where cod_usuario = '$edit' ");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <form action="../script/usuarios/editusu.php" method="POST">
                            <fieldset>
							<div class="col-md-6">
							 <div class="form-group">
								...
								<div class="form-group">
                                    <input id="textinput" value="<?php echo $row2; ?>" name="pass" type="password" placeholder="Nueva contraseña" class="form-control input-md">
                                </div>
								<div class="form-group">
                                    <input id="textinput" value="<?php echo $row3; ?>" name="nivel" type="text" placeholder="Nuevo nivel" class="form-control input-md">
                                </div>
							   ...
							   <br>
                                ...
                                <button type="submit" name="usuario" class="btn btn-lg btn-primary btn-block">Guardar cambios</button>
								</div>
                            </fieldset>
            </form>
