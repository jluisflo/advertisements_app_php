...
header("Location: ../index.php");
 ...
 $cn = conexion();
	...
	$consulta = mysqli_query($cn,"SELECT * FROM categorias where id = '$edit' ");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <form action="../script/categoria/editcategoria.php" method="POST">
                            <fieldset>
							<div class="col-md-6">
							 <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input id="textinput" value="<?php echo $row1; ?>" name="categoria" type="text" placeholder="Nuevo nombre para categoria" class="form-control input-md">
                                </div>
								 <div class="form-group">
                                    <input id="textinput" readonly="readonly" value="<?php echo $row1; ?>" name="fecha" type="text" placeholder="Nuevo nombre para categoria" class="form-control input-md">
                                </div>
