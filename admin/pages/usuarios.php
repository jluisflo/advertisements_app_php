...
header("Location: ../index.php");
	...
	$cn = conexion();
	$consulta = mysqli_query($cn,"SELECT * FROM usuario");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><small>Administrador de Usuarios </small></h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
 ...
 while ($row = mysqli_fetch_row($consulta)) 
	  {
	   ...
	   echo "<td><a href='modifusu.php?edit=$row[0]' class='btn btn-primary btn-xs' ><span class='glyphicon glyphicon-pencil'></span></a></td>";
       echo "<td><a href='../script/usuarios/eliminarusu.php?delete=$row[0]' class='btn btn-danger btn-xs' ><span class='glyphicon glyphicon-trash'></span></a></td>";
       echo '</tr>';
	  }
	 ?>
...
<div class="modal fade" id="modalagrecate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="row">
      <div class="col-md-8" >
    <form action="../script/usuarios/agreusua.php"  method="POST">   
	<div class="form-group">
       <label for="rg-from">Nombre de usuario: </label>
       <input type="text" id="categoria" name="nombre" class="form-control">
    </div>
	<div class="form-group">
       <label for="rg-from">Contraseña: </label>
       <input type="text" id="categoria" name="pass" class="form-control">
    </div>
	<div class="form-group">
       <label for="rg-from">Nivel de usuario: </label>
       <input type="text" id="categoria" name="nivel" class="form-control">
    </div>
