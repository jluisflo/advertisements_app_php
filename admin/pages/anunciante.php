...
header("Location: ../index.php");
	...
	$cn = conexion();
	$consulta = mysqli_query($cn,"SELECT * FROM anunciante");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><small>Administrador de Anunciantes </small></h2> 
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="resultados">
                                    <thead>
                                        <tr>
                                            <th>Codigo anunciante</th>
                                            <th>Nombre de anunciante</th>
                                            <th>apellido de anunciante</th>
					    <th>E-mail</th>
 ...
 while ($row = mysqli_fetch_row($consulta)) 
	  {
	   ...
	   echo "<td><a href='modifanun.php?edit=$row[0]' class='btn btn-primary btn-xs' ><span class='glyphicon glyphicon-pencil'></span></a></td>";
       echo "<td><a href='../script/anunciante/eliminaranun.php?delete=$row[0]' class='btn btn-danger btn-xs' ><span class='glyphicon glyphicon-trash'></span></a></td>";
       echo '</tr>';
	  }
	 ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar Anunciante</h4>
      </div>
      <div class="modal-body">
	  <div class="row">
      <div class="col-md-8" >
    <form action="../script/anunciante/agreanun.php"  method="POST">   
	<div class="form-group">
       <label for="rg-from">Nombre:</label>
       <input type="text" id="categoria" name="nombre" class="form-control">
    </div>
	<div class="form-group">
       <label for="rg-from">apellidos: </label>
       <input type="text" id="categoria" name="ape" class="form-control">
    </div>
	<div class="form-group">
       <label for="rg-from">E-mail: </label>
       <input type="text" id="categoria" name="mail" class="form-control">
    </div>
	<div class="form-group">
       <label for="rg-from">Contraseña: </label>
       <input type="password" id="categoria" name="contra" class="form-control">
    </div>
